...
const Register = () => {
  ...
  justify-center md:flex-row h-screen">
   {/* { LEFT SIDE} */}
   <div className="hidden w-full md:w-1/2 bg-black text-white md:flex justify-center items-center flex-col p-8 rounded-tr-[80px] rounded-br-[80px]">
