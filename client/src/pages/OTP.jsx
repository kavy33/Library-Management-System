...
const OTP = () => {
  ...
  <Link to={"/register"} className="border-2 border-black rounded-3xl font-bold w-52 py-2 px-4 fixed 
  ...
  <div className="max-w-sm w-full">
   ...
   <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px] ">
    <div className="text-center h-[400px]">
      ...
      <Link to={"/register"} className="border-2 mt-5 border-white w-full font-semibold px-8 bg-black text-white py-2 rounded-lg hover:bg-white hover:text-black transition">SIGN UP</Link>
    </div>
   </div>
