      ...
      <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
        <div className="flex flex-col gap-7 flex-[4] ">
          <div className="flex flex-col lg:flow-row gap-7 overflow-y-hidden"> 
            <div
  className="flex items-center bg-white p-5 min-h-[120px] rounded-lg
             transition hover:shadow-inner hover:-translate-y-1 duration-300
             cursor-pointer"
 onClick={() =>
  navigate("/my-borrowed-books", {
    state: { defaultTab: "nonReturned" }
  })
}
...
>
  ...
  <div className="ml-4 w-20 h-20 flex items-center justify-center bg-gray-300 rounded-lg flex-shrink-0">
    ...
    <p className="text-lg xl:text-xl font-semibold leading-tight">
      Your Returned Book List
          ...
          <div className="flex flex-col lg:flex-row gap-7">
              <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-hidden rounded-lg transition hover:shadow-inner hover:-translate-y-1 duration-300 cursor-pointer" 
                onClick={() => navigate("/books")}
              >
              <span className="w-[2px] bg-black h-20 lg:h-full"></span>
              <span className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center 
                             items-center rounded-lg"><img src={browseIcon} alt="bookIcon" className="w-8 h-8 "/></span>
        ...
        relative flex-[3] flex justify-center items-center rounded-2xl">
          ...
          <h4 className="overflow-y-hidden">"Embarking on the journy of reading fosters personal growth,
                nurturing a path towards excellence and the refinedment of character."</h4>
          <p className="text-gray-700 text-sm sm:text-lg absolute right-[35px] sm:right-[78px] bottom-[10px]">~BookWarm Team</p>
        </div>
      </div>
        </div>
